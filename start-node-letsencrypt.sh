...
# Fast and easy way to generate Let's Encrypt SSL certificates for Node-IDLL
# If you got this script externally, make sure you run it inside the Node-IDLL folder.
