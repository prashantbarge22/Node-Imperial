...
100% equivalent to 42,000,000,000 IDLL

### IDLL Genesis Supply

9.8971455428571428571428571428571% equivalent to 4,156,801,128 IDLL
...
How to compute the genesis supply:
 ...
 - Block 0 has reward 1 IDLL
 - Block 1 has reward 1,867,487,789 IDLL
 - Block 2 has reward 1,007,804,769 IDLL
 - ... Next blocks' values decrease according to a predefined discrete reward function
 - Block 39 has reward 6,306 IDLL
 - Block 40 has reward 6,113 IDLL
...
Example:
  - From block 40 to block 3,153,600, the reward is 6,000 IDLL.
  - From block 3,153,601 to block 6,307,200 the reward is 3,000 IDLL.
...
{ id: 101247,
  ...
  miner_address: "IDLL$gD5VX81cGcusj1I4aptf3ptshcCyCQ1drj$",
