/*
    Used to Radix Tree (Patricia Tree) a Buffer (CryptoIDLLData)
...
class InterfaceRadixTree extends InterfaceTree {
     ...
     * @param element can be a Base String, Buffer or CryptoIDLLData
     */
    add(input, value){

        if (!Buffer.isBuffer(input))
            input = IDLLCryptoData.createIDLLCryptoData(input).buffer;
