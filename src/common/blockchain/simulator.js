...
var IDLLCoins = new IDLLCoinsClass()
...
class BlockchainMiningReward{
    ...
    /**
     * Returns the entire distribution in IDLL sub-units including GENESIS(~9.9%)
     */
    ...
    /**
     * Returns the block[height]'s reward in IDLL sub-units
     */
    _getReward(height){
        if (height <= 40) {
            return this.v[height] * IDLLCoins.IDLL;
        }
        else {
            ...
            return IDLLCoins.IDLL * rewardFinal
        }
...
console.log('------------------')
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING-1) ) + "  before hard fork2" )  //1 forced halving in 2021
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING) ) + "  before hard fork" )  //1 forced halving in 2021
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+1) ) +  "  after hard fork 2021" )
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+2) ) + "  2021" )

console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+3153600/2 -1 ) ) + "  before 2023" ) //2 forced halving in ~2023
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+3153600/2 ) ) + "   2023" )
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+3153600/2 +1 ) ) + "   2023" )

console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+3153600 -1 ) ) + "   before 2025" ) //2 forced halving in ~2025
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+3153600 ) ) + "   2025" )
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+3153600 +1 ) ) + "   2025" )

console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+1.5*3153600 -1 ) ) + "   before 2027" ) //2 forced halving halving in ~2027
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+1.5*3153600 ) )+ " 2027" )
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+1.5*3153600 +1 ) ) + " 2027" )

console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+2*3153600 -1 ) ) + " before halving 2029" ) //2 forced halving halving in ~209
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+2*3153600 ) ) + " 2029" )
console.log ( IDLLCoins.convertToIDLL( rewarder.getFinalReward(HARD_FORK_FAST_HALVING+2*3153600 +1 ) ) + " 2029" )
