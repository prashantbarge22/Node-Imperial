...
class MiniBlockchainAccountantTree extends MiniBlockchainAccountantTreeEvents {
    ...
    updateAccount(address, value, tokenId, revertActions, showUpdate = true) {
        ...
        if (tokenId.length === consts.MINI_BLOCKCHAIN.TOKENS.IDLL_TOKEN.LENGTH && tokenId[0] === consts.MINI_BLOCKCHAIN.TOKENS.IDLL_TOKEN.VALUE) {
    ...
    */
    ...
    printAccountantTree() {
        ...
        for (let i=0; i<list.length; i++) {
            ...
            console.info( i, list[i].address, list[i].balance / IDLLCoins.IDLL );

            obj[list[i].address] = list[i].balance / IDLLCoins.IDLL;
        }
