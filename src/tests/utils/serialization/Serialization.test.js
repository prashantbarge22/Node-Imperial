...
describe('Serialization test', () => {
    ...
    it('Serialize IDLLCoins', ()=>{

        let data = [IDLLCoins.MAX_SAFE_COINS, 0, 1, 2, 3, 5, IDLLCoins.MAX_SAFE_COINS-10, IDLLCoins.MAX_SAFE_COINS-11 ];
    ...
    it('Serialize IDLLCoins - many random ', ()=>{
    ...
    it('Serialize IDLLCoins tests ', ()=>{

        let v = ["321321",7500, "112","5555",32132333, 5551233, 51323, 0, 0, 312321312, 5553434, IDLLCoins.MAX_SAFE_COINS];
        let x = [];
