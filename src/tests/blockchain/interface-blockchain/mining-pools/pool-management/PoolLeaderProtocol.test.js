...
describe('test pool leader protocol', () => {
    ...
    let testMinersList = [
        {
            address: "IDLL$gDDEDYafT8ur7EkSQzkVAZU4egSgEkH25#9TM3zKKN#Yj#eH@HsPw==",
            reward: 100,
            bestHash: TestsHelper.makeIdHex(32),
            difficulty: 0
        },
        {
            address: "IDLL$gD$q9AkZPN29xeHnuS$ykXHCqpv1@NT@R5yn4PkY#9bcxztwcDsPw==",
            reward: 201243,
            bestHash: TestsHelper.makeIdHex(32),
            difficulty: 0
        },
        {
            address: "IDLL$gCBzvQdKroa&yU4sp2X3y8*mf#q&r5k3BG3J3mBvogbE3U$SPHsPw==",
            reward: 3034556,
            bestHash: TestsHelper.makeIdHex(32),
            difficulty: 0
        },
