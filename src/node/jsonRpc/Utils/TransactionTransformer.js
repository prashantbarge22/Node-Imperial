...
class TransactionTransformer {
    ...
    transform(oTransaction, oBlock = null, i) {
        ...
        let aTransaction = {
            ...
            fee             : oTransaction.fee / IDLLCoins.IDLL,
            fee_raw         : oTransaction.fee,
            amount          : nOutputSum / IDLLCoins.IDLL,
            amount_raw      : nOutputSum,
            total_amount    : nInputSum / IDLLCoins.IDLL,
            total_amount_raw: nInputSum,
            timestamp       : null,
            timestamp_UTC   : null,
            ...
            createdAtUTC    : null,
            block_id        : null,
            from            : {trxs: [], addresses: [], amount: nInputSum  / IDLLCoins.IDLL, amount_raw: nInputSum},
        ...
        oTransaction.from.addresses.forEach((oAddress) => {
            aTransaction.from.trxs.push({
                ...
                trx_from_amount    : oAddress.amount / IDLLCoins.IDLL,
        ...
        oTransaction.to.addresses.forEach((oAddress) => {
            aTransaction.to.trxs.push({
                ...
                trx_to_amount    : oAddress.amount / IDLLCoins.IDLL,
